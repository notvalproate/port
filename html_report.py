...
def get_market_status():
    url = "[nseindia.com](https://www.nseindia.com/api/marketStatus)"
    headers = {
        "User-Agent": "Mozilla/5.0",
        "Accept-Language": "en-US,en;q=0.9",
        "Referer": "[nseindia.com](https://www.nseindia.com/)"
    }
    try:
        session = requests.Session()
        session.get("[nseindia.com](https://www.nseindia.com)", headers=headers)
...
NSE_HOME = "[nseindia.com](https://www.nseindia.com)"
ADV_DEC_API = "[nseindia.com](https://www.nseindia.com/api/live-analysis-advance)"
...
try:
    ...
    total_breadth = advance_data["advance"]["count"]["Total"]
except:
    advances = declines = unchanged = total_breadth = 0

log(f"Advances  : {advances}")
log(f"Declines  : {declines}")
log(f"Unchanged : {unchanged}")
log(f"Total     : {total_breadth}\n")
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div class="stat">
                    ...
                    <div class="stat-value large {color_class(total_profit)}">{plus(total_profit)}{format_currency(abs(total_profit))}</div>
                </div>
                <div class="stat">
            ...
            <div class="card">
                ...
                <div class="stat">
                    ...
                    <div class="stat-value large {color_class(portfolio_return_amt)}">{plus(portfolio_return_amt)}{format_currency(abs(portfolio_return_amt))}</div>
                </div>
                <div class="stat">
...
"""
    ...
    html_content += f"""
                    <tr>
                        ...
                        <td class="{color_class(r['daily_pnl'])}">{plus(r['daily_pnl'])}{format_currency(abs(r['daily_pnl']))}</td>
                        <td class="{color_class(r['total_pnl'])}">{plus(r['total_pnl'])}{format_currency(abs(r['total_pnl']))}</td>
...
# Market Breadth Card
breadth_total = advances + declines if (advances + declines) > 0 else 1
...
html_content += f"""
            <div class="card">
                ...
                <div class="breadth-visual">
                    <div class="breadth-advances" style="width: {adv_percent}%;">{advances}</div>
                    <div class="breadth-declines" style="width: {dec_percent}%;">{declines}</div>
                </div>
